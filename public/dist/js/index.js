...
/***/ "./public/assets/js/modules/ajax_test.js":
/*!***********************************************!*\
  !*** ./public/assets/js/modules/ajax_test.js ***!
  \***********************************************/
/***/ (function(module) {
...
function ajax_test() {
  ...
  var getData = function getData() {
    ...
    sendHttpRequest('get', '/first-project-austeam/home/ajaxtest/').then(function (responseData) {
  ...
  var sendData = function sendData() {
    ...
    sendHttpRequest('post', '/first-project-austeam/users/login', json).then(function (responseData) {
      console.log(responseData);
    });
  };
...
function loginModal() {
  ...
  function signupform() {
    ...
    template1 += "</dl>";
    template1 += "<div>";
    template1 += '<button class="login-btn" name="submit_login">Create account</button>';
    template1 += "</div>";
    template1 += "</form>";
